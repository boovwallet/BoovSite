...
export function SiteNav() {
  ...
  // next-view-transitions' Link doesn't forward refs, so the magnetic effect
  // lives on a wrapper span instead.
    ...
    <header className={`${styles.nav} vt-nav ${scrolled ? styles.scrolled : ""}`}>
      <div className={styles.inner}>
        ...
        <div className={styles.actions}>
          ...
          <span ref={ctaRef} className={styles.ctaWrap}>
            <Link href="/#join" className={styles.cta} data-cursor data-cursor-label="Join">
              Join waitlist
            </Link>
          </span>
        </div>
